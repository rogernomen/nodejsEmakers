    ...
    if(mode != false && mode.toUpperCase() == 'FULL'){
		var queryParcels = ""+
			"SELECT "+
				...
				"p.fecha_entrega_estimada_inf, "+
				"p.fecha_entrega_estimada_sup, "+
				"p.cf_itinerario, "+
				"p.cf_tipo_via, "+
        ...
        if (error) {
        	...
        	var queryIntento = ""+
        		"INSERT INTO argos_entregas_intentos "+
        			"(id2, cf_agencia, cf_entrega, cf_itinerario, orden_itinerario, cf_repartidor, cf_estado, fecha_intento, texto_intento, lat, lon) "+
        		"VALUES ("+ 
        			"NULL, "+
...
var updateCannotDeliver = function(cannotDelivery_data, callback){
    ...
    this._query(query, function(error, results){
        if (error) {
        	...
        	var queryIntento = ""+
        		"INSERT INTO argos_entregas_intentos "+
        			"(id2, cf_agencia, cf_entrega, cf_itinerario, orden_itinerario, cf_repartidor, cf_estado, fecha_intento, tono_duracion, telf_duracion, lat, lon) "+
        		"VALUES ("+ 
        			"NULL, "+
