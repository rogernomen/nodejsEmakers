			...
			self._query(queryCheckPrecargas, function(error, resultsPrecargas){
				if(error){
					...
					var carga_response = {
	        			...
	        			cf_franja_premium: resultsPrecargas[0].cf_franja_premium,
	        			descripcion_franja_premium: resultsPrecargas[0].descripcion_franja_premium,
								        	...
								        	self._query(queryLog, function(error, resultLog){
									        	if (error) {
									        		...
									        		var carga_response = {
									        			...
									        			cf_franja_premium: results[key].cf_franja_premium,
									        			descripcion_franja_premium: results[key].descripcion_franja_premium,
